...
const guestList2: string[] = ["Maria", "Aslam", "Shahzad"];
...
const guestsNotAvailable1: string[] = ["Maria", "Aslam"];
...
const additionalGuests: string[] = ["Imran", "Bilal", "Kiran"];
...
// Storing the current list of people to invite to dinner
const guestList3: string[] = ["Maya Angelou", "Leonardo da Vinci", "Marie Curie"];
...
// Guests who can't make it
const guestsNotAvailable: string[] = ["Maya Angelou", "Leonardo da Vinci"];
...
// Adding more guests to the list
const additionalGuests1: string[] = ["Albert Einstein", "Nelson Mandela", "Ada Lovelace"];
