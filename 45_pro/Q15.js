...
const guestList1 = ["Farhan", "Maria", "Aslam"];
...
const guestNotAvailable = "Farhan";
console.log(`${guestNotAvailable} can't make it to the dinner.`);
// Modifying the guest list and replacing the guest
const newGuest = "Emric";
const indexOfGuestNotAvailable = guestList.indexOf(guestNotAvailable);
