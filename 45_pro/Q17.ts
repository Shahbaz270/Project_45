...
const guestList4: string[] = ["Isaac Newton", "Maya Angelou", "Rosa Parks", "Leonardo da Vinci", "Marie Curie", "Albert Einstein", "Nelson Mandela", "Ada Lovelace"];
...
const guestsNotAvailable2: string[] = ["Maya Angelou", "Leonardo da Vinci"];
...
const additionalGuests2: string[] = ["Nelson Mandela", "Ada Lovelace"];
